/**
 * transcripts.ts — STT transcript storage for H.U.G.H.
 *
 * The audio bridge (LFM STT or external) calls recordTranscript to persist
 * speech-to-text results. H.U.G.H. queries these for episodic memory synthesis.
 *
...
// ── RECORD TRANSCRIPT ──────────────────────────────────────────────────────
// Called by the audio bridge via POST /api/transcripts/record
