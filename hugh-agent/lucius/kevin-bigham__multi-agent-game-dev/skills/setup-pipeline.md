...
3. Create AGENTS.md at project root with role definitions:
   ```markdown
   # Agents — <PROJECT_NAME>
...
7. Create SPRINT_LOG.md:
   ...
   **Agent:** Operations
   ...
   - Created AGENTS.md, CLAUDE.md, NEXT_TASK.md, BACKLOG.md
   ```
...
9. Verify the structure:
   ```bash
   ls -la AGENTS.md CLAUDE.md NEXT_TASK.md BACKLOG.md SPRINT_LOG.md
   ls -la .codex/<ACRONYM>/
   ```
...
- AGENTS.md with role definitions and boot sequence
